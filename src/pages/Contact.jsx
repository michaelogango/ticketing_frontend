  ...
  return (
    ...
    <div className="max-w-2xl mx-auto p-8 bg-white rounded-2xl shadow-lg">
      ...
      <form className="space-y-6">
        <div className="grid grid-cols-2 gap-6">
          <div>
            <input
              ...
              className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-100 rounded-xl focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-300"
            />
          </div>
          <div>
            <input
        ...
        <div>
          <select className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-100 rounded-xl focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-300 appearance-none">
            ...
            <div className="space-y-3">
              {['Online search', 'Other search', 'Other'].map((option) => (
                <label key={option} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all duration-300 cursor-pointer">
                  <input type="radio" name="source" className="w-4 h-4 text-orange-600 focus:ring-orange-500" />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {['Brand review', 'Service package', 'Other'].map((option) => (
                <label key={option} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all duration-300 cursor-pointer">
                  <input type="radio" name="looking" className="w-4 h-4 text-orange-600 focus:ring-orange-500" />
                  <span className="text-gray-700">{option}</span>
                </label>
              ))}
            </div>
        ...
        <button
          type="submit"
          className="w-full bg-gradient-to-r from-orange-600 to-white text-white py-4 px-6 rounded-xl text-lg font-semibold hover:opacity-90 transform hover:-translate-y-0.5 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
        >
          Submit
        </button>
      </form>
